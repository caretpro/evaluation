...
public class RandomPlayer extends Player {
	 ...
	 * @throws IllegalArgumentException if availableMoves is null or empty
	 */
	@Override
	public Move nextMove(Game game, Move[] availableMoves) {
		...
		Move chosenMove = availableMoves[index];
		if (chosenMove == null) {
			throw new IllegalStateException("Chosen move is null.");
		}
		return chosenMove;
	}
}