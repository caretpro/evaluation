...
public class GameState {
    ...
    public int increaseNumLives(final int delta) {
        ...
        numLives += delta;
        if (numLives < 0) { // go to unlimited if overflow/negative
     ...
     */
    public int getScore() {
        int base = gameBoard.size();
        int gemsScore = (initialNumOfGems - gameBoard.getNumGems()) * 10;
        int movesPenalty = numMoves;
        int undoPenalty = moveStack.getUndoCount() * 2;
        int deathPenalty = numDeaths * 4;
        return base + gemsScore - movesPenalty - undoPenalty - deathPenalty;
    }
    ...
    public GameBoardController getGameBoardController() {
        return new GameBoardController(gameBoard, this, moveStack);
    }
