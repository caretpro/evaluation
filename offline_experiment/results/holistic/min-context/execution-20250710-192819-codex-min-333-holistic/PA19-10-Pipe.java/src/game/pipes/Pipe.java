...
/**
 * A pipe segment on the map. Each pipe has a Shape (e.g. horizontal, top‑left corner, cross, …),
...
public class Pipe implements MapElement {
    ...
    public Direction[] getConnections() {
        char c = toSingleChar();
        Direction[] conns = PipePatterns.connectionsFor(c);
        if (conns == null) {
            throw new IllegalStateException("Unknown pipe pattern for char: " + c);
        }
        return conns;
    }
