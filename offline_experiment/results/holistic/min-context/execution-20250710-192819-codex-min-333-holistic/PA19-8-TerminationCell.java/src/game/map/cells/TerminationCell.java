...
public class TerminationCell extends Cell {
    ...
    public TerminationCell(Coordinate coord, Direction direction, Type type) {
        ...
        this.type = type;
        // initialize the cell's pipe pattern as a termination (source or sink)
        this.pattern = PipePatterns.terminationPattern(direction, type);
    }
    ...
    public char toSingleChar() {
        return isFilled
                ? pattern.getFilledChar()
                : pattern.getUnfilledChar();
    }
