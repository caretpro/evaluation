...
class PipeQueue {
    ...
    void undo(final Pipe pipe) {
        if (pipe == null) {
            throw new IllegalArgumentException("Cannot undo null pipe.");
        }
    ...
    private static Pipe generateNewPipe() {
        ...
        int rnd = RNG.nextInt(types.length);
        return new Pipe(types[rnd]);
    }
}