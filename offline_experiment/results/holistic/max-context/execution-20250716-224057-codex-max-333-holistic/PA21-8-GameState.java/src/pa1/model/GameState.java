...
public class GameState {
    ...
    public int increaseNumLives(final int delta) {
        ...
        numLives += delta;
        if (numLives < 0) {
            // overflow or turned negative → treat as unlimited
     ...
     * </p>
     * <ul>
     * <li>The initial score of any game board is {@code 0}.</li>
     * <li>Each gem collected is worth 10 points.</li>
     ...
     */
    public int getScore() {
        // initial score is defined to be 0
        int score = 0;
        // points for gems collected so far = (initial gems – current gems) * 10
        score += (initialNumOfGems - getNumGems()) * 10;
        // each valid move deducts 1 point
        score -= numMoves;
        // each undo deducts 2 points
        score -= moveStack.getPopCount() * 2;
        // each death deducts an extra 4 points
        score -= numDeaths * 4;
        return score;
    }
