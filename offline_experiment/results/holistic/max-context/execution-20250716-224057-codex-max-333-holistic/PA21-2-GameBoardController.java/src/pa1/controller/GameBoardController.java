...
public class GameBoardController {
    ...
    public MoveResult makeMove(final Direction direction) {
        ...
        // Compute the move result without mutating
        final Position origPos = Objects.requireNonNull(gameBoard.getPlayer().getOwner()).getPosition();
    ...
    public void undoMove(final MoveResult prevMove) {
        ...
        if (prevMove instanceof MoveResult.Valid.Alive alive) {
            ...
            Position moved = alive.newPosition;
            // move player back
            gameBoard.getEntityCell(moved).setEntity(null);
        ...
        // Invalid and Valid.Dead made no board mutations, so nothing to undo
    }
