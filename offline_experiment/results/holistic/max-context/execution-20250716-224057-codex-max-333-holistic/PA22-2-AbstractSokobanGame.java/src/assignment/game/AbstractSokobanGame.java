...
public abstract class AbstractSokobanGame implements SokobanGame {
    ...
    protected boolean shouldStop() {
        // Stop if user asked to exit or if all boxes are on destinations (win).
    ...
    @Override
    public void run() {
        // Concrete subclasses must implement the actual loop (e.g. I/O handling),
        // typically calling processAction() and checking shouldStop().
        internalRunLoop();
    }

    /**
     * Subclasses implement their own I/O-driven loop here, using processAction() and shouldStop().
     */
    protected abstract void internalRunLoop();
}