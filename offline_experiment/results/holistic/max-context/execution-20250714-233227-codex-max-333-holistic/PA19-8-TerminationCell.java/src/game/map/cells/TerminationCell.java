...
public class TerminationCell extends Cell {
     ...
     */
    public TerminationCell(@NotNull Coordinate coord,
    ...
    public char toSingleChar() {
        ...
        if (type == Type.SOURCE) {
            patterns = isFilled
                    ? PipePatterns.SOURCE_END_PATTERN_FILLED
                    : PipePatterns.SOURCE_END_PATTERN;
        } else {
            patterns = isFilled
                    ? PipePatterns.SINK_END_PATTERN_FILLED
                    : PipePatterns.SINK_END_PATTERN;
        }
        int index = pointingTo.ordinal();
