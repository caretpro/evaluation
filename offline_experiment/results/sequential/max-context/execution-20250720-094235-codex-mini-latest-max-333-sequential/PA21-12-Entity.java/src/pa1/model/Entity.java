...
public abstract class Entity implements BoardElement {
     ...
     */
    public final @Nullable EntityCell getOwner() {
        return owner;
    }
    ...
    /**
     * Sets the new owner of this entity. <p> Depending on your implementation, you should not need to call {@link EntityCell#setEntity(Entity)},
     * since this method should only be called from {@link EntityCell#setEntity(Entity)}. </p>
