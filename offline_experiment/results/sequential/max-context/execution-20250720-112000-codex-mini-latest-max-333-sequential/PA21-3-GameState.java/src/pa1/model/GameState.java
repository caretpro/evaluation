...
public class GameState {
    ...
    /**
     * Creates an instance. <p> Note: Do NOT throw an exception when {@code numLives} is zero.
     * This will be used in our testing. </p>
     *
     * @param gameBoard The game board to be managed by this instance.
     * @param numLives  Number of lives the player has. If the value is negative,
     *                  treat as if the player has an unlimited number of lives.
     */
    ...
    /**
     * Checks whether the game has been won. <p> The game is won when there are no gems
     * left in the game board. </p>
     *
    ...
    /**
     * Checks whether the game has been lost. <p> The game is lost when the player has no
     * lives remaining. For games which the player has unlimited lives, this condition
     * should never trigger. </p>
     *
     ...
     * @return The new number of lives of the player. If the player has unlimited number
     *         of lives, returns {@link Integer#MAX_VALUE}.
     */
     ...
     *
     * @return The new number of lives of the player. If the player has unlimited
     *         number of lives, returns {@link Integer#MAX_VALUE}.
     */
    ...
    /**
     * @return The number of lives a player has. If the player has an unlimited number
     *         of lives, returns {@link Integer#MAX_VALUE}.
     */
    ...
    /**
     * <p> At any point of the game, the score should be computed using the following formula: </p>
     * <ul>
     ...
     */
    public int getScore() {
        int initialScore   = gameBoard.getNumRows() * gameBoard.getNumCols();
        int gemPoints      = getNumGems() * 10;
        int movePenalty    = getNumMoves();
        int undoPenalty    = moveStack.getPopCount() * 2;
