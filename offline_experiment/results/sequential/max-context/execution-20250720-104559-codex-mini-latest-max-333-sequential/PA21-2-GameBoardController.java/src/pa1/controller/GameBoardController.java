...
public class GameBoardController {
	...
	public MoveResult makeMove(final Direction direction) {
		final MoveResult res = tryMove(gameBoard.getPlayer().getOwner().getPosition(), direction);
		if (!(res instanceof MoveResult.Valid.Alive alive)) {
			return res;
		}
		...
		gameBoard.getPlayer().setPosition(alive.newPosition);
		return alive;
	}
