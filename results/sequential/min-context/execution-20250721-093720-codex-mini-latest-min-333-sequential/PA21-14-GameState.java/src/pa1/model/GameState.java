...
public class GameState {
     ...
     * @param gameBoard  The game board to be managed by this instance.
     * @param numLives   Number of lives the player has. If the value is negative, treat as if
     *                   the player has an unlimited number of lives.
     */
    ...
    /**
     * Checks whether the game has been won. <p> The game is won when there are no gems left
     * in the game board. </p>
     * @return Whether the player has won the game.
     */
    public boolean hasWon() {
        return gameBoard.countGems() == 0;
    }

    /**
     * Checks whether the game has been lost. <p> The game is lost when the player has no lives
     * remaining. For games which the player has unlimited lives, this condition should never
     * trigger. </p>
     ...
     * @return The new number of lives of the player. If the player has unlimited number of
     * lives, returns {@link Integer#MAX_VALUE}.
     */
    ...
    /**
     * @return The number of lives a player has. If the player has an unlimited number of
     * lives, returns {@link Integer#MAX_VALUE}.
     */
    ...
    public int getScore() {
        ...
        int gemsCollected = initialNumOfGems - gameBoard.countGems();
        int gemPoints   = gemsCollected * 10;
        int movePenalty = numMoves;
        int undoPenalty = moveStack.getNumUndos() * 2;
        int deathPenalty = numDeaths * 4;
        return boardSize + gemPoints - movePenalty - undoPenalty - deathPenalty;
    }
