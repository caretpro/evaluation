...
public class TerminationCell extends Cell {
	...
	public void TerminationCell(Coordinate coord, Direction direction, Type type) {
		...
		this.type = type;
		setPipePattern(PipePatterns.endpoint(direction));
	}
	...
	/**
	 * Returns the character used to draw an endpoint (source/sink) depending on the direction and type.
	 */
	public static char endpointChar(Direction dir, EndpointType type) {
	}
}
