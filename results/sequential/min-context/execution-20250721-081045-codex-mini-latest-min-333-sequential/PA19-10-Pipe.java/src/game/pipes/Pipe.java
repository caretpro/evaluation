...
public class Pipe implements MapElement {
	...
	/**
	 * Converts a String to a Pipe. <p> Here is the list of ASCII representation to the pipes: TL: Top-Left TR: Top-Right BL: Bottom-Left BR: Bottom-Right HZ: Horizontal VT: Vertical CR: Cross </p>
	...
	public static Pipe fromString(String rep) {
		if (rep == null) {
			throw new IllegalArgumentException("Pipe representation may not be null");
		}
		switch (rep) {
		case "HZ":
