...
public class GameState {
     ...
     * remaining. For games which the player has unlimited lives, this condition should never trigger. </p>
     *
     ...
     * @return The new number of lives of the player. If the player has unlimited number of lives,
    ...
    /**
     * @return The number of lives a player has. If the player has an unlimited number of lives,
     * returns {@link Integer#MAX_VALUE}.
     */
    ...
    public int getScore() {
        ...
        int gemsValue = 10 * gameBoard.getNumGems();
        int movePenalty = numMoves;
        int undoPenalty = 2 * moveStack.getPopCount();
        int deathPenalty = 4 * numDeaths;
        return gameBoardSize + gemsValue - movePenalty - undoPenalty - deathPenalty;
    }
