...
public class GameState {
    ...
    public GameBoardController getGameBoardController() {
        return new GameBoardController(gameBoard, this);
    }
    ...
    /**
     * Checks whether the game has been lost. <p> The game is lost when the player has no lives remaining. For games which
     * the player has unlimited lives, this condition should never trigger. </p>
     *
    ...
    public int getScore() {
        ...
        int gemsLeft = gameBoard.getNumGems();
        int gemScore = gemsLeft * 10;
        int movePenalty = numMoves;
        int undoPenalty = moveStack.getPopCount() * 2;
        int deathPenalty = numDeaths * 4;
        return boardSize + gemScore - movePenalty - undoPenalty - deathPenalty;
    }
    ...
    public GameBoardView getGameBoardView() {
        return GameBoardView.of(gameBoard);
    }
