...
public class ConsolePlayer extends Player {
	...
	public Move nextMove(Game game, Move[] availableMoves) {
		...
		while (true) {
			...
			chosenMove = parseMove(line);
			if (chosenMove == null) {
				System.out.println("Invalid move format. Please use e.g. a1->b3.");
				continue;
			}
			error = validateMove(game, chosenMove);
			if (error != null) {
			...
			if (!found) {
				System.out.println("That move is not in your list of available moves.");
				continue;
			}
			break;
		}
