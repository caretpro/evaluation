...
public class Position {
     ...
     */
    @NotNull
    public Position offsetBy(@NotNull PositionOffset offset) {
    ...
    public Position offsetByOrNull(int dRow, int dCol, int numRows, int numCols) {
        ...
        // Safe to construct because newRow/newCol are non-negative
     ...
     */
    @Nullable
    public Position offsetByOrNull(@NotNull PositionOffset offset, int numRows, int numCols) {
