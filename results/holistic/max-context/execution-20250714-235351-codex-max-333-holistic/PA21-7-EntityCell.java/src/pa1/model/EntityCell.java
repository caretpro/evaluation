...
public class EntityCell extends Cell {
     ...
     *
     * package‐private so that existing tests (EntityCellTest, StopCellTest) can directly inspect it.
     */
    @Nullable
    Entity entity = null;
     ...
     * </ul>
     *
     * @param newEntity The new {@link Entity} to place in this cell, or {@code null} to clear the cell.
    ...
    public Entity setEntity(@Nullable final Entity newEntity) {
        ...
        // 2) detach newEntity from its current owner (if any)
        final EntityCell prevOwner = newEntity.getOwner();
        if (prevOwner != null) {
            prevOwner.entity = null;
        }

        // 3) attach newEntity here
