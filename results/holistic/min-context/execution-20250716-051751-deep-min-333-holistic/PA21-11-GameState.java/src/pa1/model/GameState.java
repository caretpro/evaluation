...
public class GameState {
     ...
     */
    public int getScore() {
        final int DEFAULT_BOARD_SIZE = 100;
        int gameBoardSize = DEFAULT_BOARD_SIZE;
        int gemPoints = (initialNumOfGems - getNumGems()) * 10;
        int movePenalty = numMoves;
        // Using numMoves as a proxy for undo count (since we can't access moveStack directly)
        int undoPenalty = numMoves * 2;
