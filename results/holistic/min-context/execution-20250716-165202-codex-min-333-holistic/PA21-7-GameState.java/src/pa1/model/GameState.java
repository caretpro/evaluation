...
public class GameState {
     ...
     * </p>
     * <ul>
     * <li>The initial score of any game board is {@code boardSize}.</li>
     ...
     */
    public int getScore() {
        int boardSize = gameBoard.getWidth() * gameBoard.getHeight();
        int gemsCollected = initialNumOfGems - getNumGems();
        int undoCount = moveStack.getUndoCount();
        // initial score + 10pt per collected gem - 1pt per move - 2pt per undo - 4pt per death
        return boardSize
            + gemsCollected * 10
            - numMoves
            - undoCount * 2
    ...
    public GameBoardController getGameBoardController() {
        return gameBoard.getController(moveStack);
    }
